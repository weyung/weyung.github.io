...
function validateCodeBlockLanguages(content, postTitle) {
  ...
  const supportedLangs = new Set([
    "python", "py", "javascript", "js", "typescript", "ts", "php", "html", "css", 
    "bash", "sh", "shell", "yaml", "yml", "json", "jsonc", "c", "cpp", "c++", "rust", "rs", 
    "go", "golang", "sql", "markdown", "md", "typst", "typ", "solidity", "ini", "toml", 
    "powershell", "ps1", "properties", "latex", "tex", "makefile", "xml", "diff",
    "java", "csharp", "cs", "dockerfile", "docker", "asm", "csv", "cmd", "batch", "bat",
    "nginx", "apache", "lua", "vim", "zsh", "cmake", "ruby", "rb",
