...
import { stageSearchIndex } from "./search.mjs";

const SHIKI_SUPPORTED_LANGS = new Set([
...
function validateCodeBlockLanguages(content, postTitle) {
  ...
  while ((match = codeBlockRegex.exec(content)) !== null) {
    ...
    if (!SHIKI_SUPPORTED_LANGS.has(lang)) {
...
export async function buildSite({ outDirName, jobs, configPath, cacheRoot }) {
  ...
  stageSearchIndex(posts, slugMaps, outputSiteDir, paths.stagingSiteDir, statusMap);
