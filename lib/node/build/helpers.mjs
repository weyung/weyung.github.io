import { copyFileSync, cpSync, existsSync, mkdirSync, readFileSync, readdirSync, rmSync, statSync, writeFileSync, unlinkSync } from "node:fs";
...
export function incrementalSync(stagingDir, outputDir) {
  ...
  for (const stagingPath of stagingFiles) {
    ...
    if (fileContentEqual(stagingPath, outputPath)) {
      ...
      copyFileSync(stagingPath, outputPath);
      updatedCount++;
    }
  }
