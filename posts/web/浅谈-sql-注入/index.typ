...
#show: template-post.with(
  title: "浅谈 SQL 注入",
  description: "一边瞎扯一边学习，也是很爽的。",
  tags: ("CTF", "Web", "渗透",),
  category: "Web",
  date: datetime(year: 2025, month: 3, day: 29)
)
...
可以看下知乎的#link("https://www.zhihu.com/question/52869762")[这个回答]，大概意思如下：
...
#link("https://www.zhihu.com/question/52869762")
#link("https://www.freebuf.com/articles/web/339118.html")
