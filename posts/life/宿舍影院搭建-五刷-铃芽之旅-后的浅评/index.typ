...
之前用的显示屏是 16:9 27 英寸屏，但现在很多电影都是宽幕，在宿舍用投影仪也不现实 #strike[（其实也不是完全不现实）]，所以就买了一个 21:9 34 英寸的带鱼屏。因为对床开着灯会导致屏幕反光，就买了个桌帘挡着，效果就很好了。
...
- 色准
看 $Delta$E，越小越好，一般 2 以内就可以了，但是这个参数一般是指出厂的_平均值_，具体在自己收到的机子是不一定，看自己运气，不过一般人看不出色偏。而且我发现我眼镜是防蓝光的，戴上看屏幕色温明显升高，有空还是去配个普通镜片吧。
...
- 对比度
就是最白和最黑时亮度的比值，一般 VA 屏的对比度要高点，如果不打游戏就直接 VA 屏，对比度会比较高，4000:1 以上比较好了。主要还是看_原生对比度_，所谓动态对比度就是通过调整背光亮度来实现的，我直接关掉背光，那动态对比度就是无穷大了，参考价值不大。
...
首先_我觉得最不合适的就是分类在爱情片里_，《铃芽之旅》的爱情线虽然勉强算是完整，但着笔确实太少，只能说能圆上，其中最大的问题在于对草太的人物刻画十分单薄，两人的独处篇幅也少。
其次这个电影_并不是逻辑混乱的_，当然也不能说逻辑十分完整。第一遍看的时候我也很懵，但后来越看越合理，许多情节都是伏笔。
这里给出几个我的观点，仅供参考。

- 铃芽真的是恋爱脑吗？
首先我们要知道一个设定，那就是铃芽的母亲是在 311 地震中丧生的，这带给铃芽很大的打击，电影开头里，铃芽梦见她小时候在常世找妈妈，表明_铃芽对母亲的逝去始终无法释怀_。
我认为铃芽一开始带草太回家一方面是因为她跟随母亲当护士的职业操守，一方面自然是好奇。铃芽跟着草太和大臣一起上船也不难理解，椅子是她妈妈留下的遗物，总不能不管吧。

- 黄蝴蝶的含义是什么？
我比较赞同_黄蝴蝶是铃芽母亲_的说法。如果说前面只是普通的暗示，那么电影结尾铃芽看着小时候的自己，哭着说“妈妈，我该怎么办”时，黄蝴蝶围着椅子飞，给她指明方向时，就是新海诚明着说这就是铃芽妈妈了。

- 东京的要石是被谁拔出的？
我的猜测是_大臣_拔出的，作案动机我也不能十分揣测明白，但是作案时间是具备的，大臣消失了一会蚓厄就爆发了。
