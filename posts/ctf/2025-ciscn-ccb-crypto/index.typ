...
#show: template-post.with(
  ...
  description: "四个一血，那就是四血，四血就是没血，没血就是菜鸡，所以我是菜鸡",
  tags: ("CTF", "Crypto",),
  category: "CTF",
...
注意到 $n - p - q = phi.alt (n) - 1$，所以 $h$ 就是 $514p - 114q$ 的逆元，这个时候代入 $q = n/p$ 就能化成一个关于 $p$ 的一元二次方程，用通解解出来就行了。
...
原
#link("https://github.com/DownUnderCTF/Challenges_2023_Public/blob/main/crypto/fnv/solve/solution_joseph_LLL.sage")[DownUnderCTF2023 fnv]
有空再来分析
