...
+ $integral alpha ^x"d"x = frac(1, ln alpha ) alpha ^x+C( alpha >0, alpha != 1)$
+ $"intfrac"(1, x)"d"x = ln |x|+C$
...
*例* 证明当 $e < a < b < e^2$ 时，$(b-a)frac(2, e^2)< ln ^2b- ln ^2a<frac(4, e)(b-a)$
*解*
...
+ $cos x = 1 - frac(1, 2!)x^2 + dots.c + (-1)^n"fracx"^(2n)(2n)! + o(x^(2n+1))$
