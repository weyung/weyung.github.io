...
#show: template-post.with(
  title: "群",
  description: "有人问一个小女孩，3+4 等于几啊？
小女孩说：“不知道，但我知道 3+4 等于 4+3 .”
这人只好接着问：“为什么呀？”
小女孩答道：“因为整数与整数加法构成了阿贝尔群。”",
  tags: ("数学", "抽象代数", "Crypto",),
  category: "Crypto",
  date: datetime(year: 2022, month: 3, day: 8)
)
...
群，一个概念，也并非什么高深的东西，就是一个集合和集合上的运算，注意这个_集合上的_，已经包含了封闭律的意思，所谓封闭律，就是集合上的两个元素的运算结果还在这个集合，比如整数的加法和乘法，而整数的除法就不是了。而在这里的运算已经是一种泛义的说法，包括但不限于加法、乘法、除法、求余等等，甚于我定义出来的运算也是一种运算。在群中的运算一般用$compose$或$dot$表示，有时也姑且称之为乘，但注意大多时不是指数的乘法。
同时，群还满足_结合律_，存在_单位元_和_逆元_。
...
#quote[
插播一下：混进一个抽代群时有一个进群验证，题目是给出 _A5 的全部正规子群_，而我甚至连 A5 是啥都不知道，but 我有_sagemath_，嘿嘿，直接跑出单位元和 A5 本身，我又试了几下，发现只有 A4 除开单位元和自身外有其他正规子群，非常奇妙。代码如下：
]
