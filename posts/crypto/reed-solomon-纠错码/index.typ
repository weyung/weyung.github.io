...
#show: template-post.with(
  ...
  description: "终于有时间整理一下了，爆破毕竟还是太粗鲁了。",
  tags: ("数学", "Crypto", "抽象代数", "CTF",),
  category: "Crypto",
  date: datetime(year: 2022, month: 9, day: 17)
)
...
照着#link("https://zhuanlan.zhihu.com/p/104306038")[这篇文章]搓了个 PGZ 解码器，代码如下：
...
- #link("https://zhuanlan.zhihu.com/p/104306038")
- #link("https://eprint.iacr.org/2017/733.pdf")
