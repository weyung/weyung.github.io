...
$ m="beginpmatrix"
 ...
 "endpmatrix" $
    ...
    *___**___**___**___*\*\*\*\*
    ...
    在线性代数中，一般的，我们在欧几里得空间即*实数域*里讨论向量的*实数系*组合问题，此时 145 维向量空间里的每个向量都可以由 145 个线性无关的向量线性表出。而格中是在向量的*整数系*组合下讨论问题，此时情况就有所不同了，比如以 $(1,1)$ 和 $(-1,1)$ 为基张成的格并不包括 $(1,0)$ 等向量，即不存在整数 $m,n$ 满足 $m_(1,1)+n_(-1,1)=(1,0)$ 。
