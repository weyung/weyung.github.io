...
#show: template-post.with(
  title: "一个简单的作业提交平台",
  description: "这个项目大概是上星期五晚开始做的，之所以现在才写这篇文，纯粹是因为没有时间，刚好今早把高数写完了， CAD 又不想动，于是便借此时间简单总结一下。",
  tags: ("PHP",),
  category: "小项目",
  date: datetime(year: 2021, month: 12, day: 19)
)
...
_文件大小非空且大小须小于512KB(后来改成了666KB)_ ：否则给你当网盘使那我服务器也是难顶，而且源文件最大也没什么可能超过 10 KB，截图预计也是几十 KB
_upload目录的访问限制_：可不能给随便偷了作业看
_姓名不能为空且不多于4个字_：这个问过课代表，我们班的名字没有超过 3 个字的
_学号范围_：086-199 ，但有一个人的学号孤悬在外，有些奇怪（乐）
_姓名和学号的联合验证_：这个是前两天才加上去的，主要是忘了之前的军事课有份名单（但是那位竟然是没有的，再处理吧）
...
_#link("https://github.com/weyung/A-simple-homework-submission-platform")_
