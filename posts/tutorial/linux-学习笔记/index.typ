...
#show: template-post.with(
  title: "Linux 学习笔记",
  description: "最近用到 Linux 挺多，整理一下。",
  tags: ("Linux",),
  category: "Tutorial",
  date: datetime(year: 2022, month: 7, day: 7)
)
...
#quote[
oh-my-posh 官方文档：#link("https://ohmyposh.dev/docs/")
]
...
不过这只是一个快照，如果想看动态的，就用 #link("#top")[top] 命令。
...
#link("https://www.lxlinux.net/1431.html")
菜鸟教程
#link("https://blog.csdn.net/KevinChen2019/article/details/119697489")
#link("https://blog.csdn.net/lucky__peng/article/details/124268817")
#link("https://blog.csdn.net/liuxiao723846/article/details/125042549")
