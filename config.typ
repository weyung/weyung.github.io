...
#let tag-options = (
  ...
  "LLM": (preset: "gray", "icon": "/assets/icons/tag-lucide-cpu.svg"),
  ...
  "pwn": (preset: "gray", "icon": "/assets/icons/tag-lucide-skull.svg"),
  ...
  "数学": (preset: "gray", "icon": "/assets/icons/tag-lucide-calculator.svg"),
  ...
  "计组": (preset: "gray", "icon": "/assets/icons/tag-lucide-hard-drive.svg"),
